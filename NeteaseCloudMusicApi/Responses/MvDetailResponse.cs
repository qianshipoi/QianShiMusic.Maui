...
public class MvDetailResponse
{
    ...
    public string LoadingPic { get; set; } = default!;
    public string BufferPic { get; set; } = default!;
    public string LoadingPicFS { get; set; } = default!;
    public string BufferPicFS { get; set; } = default!;
