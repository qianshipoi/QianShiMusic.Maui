...
namespace QianShiMusic.Models
{
    ...
    public class NeteaseTrackService : ITrackService
    {
        ...
        public Task<ITrack?> GetTrackDetailAsync(long trackId)
        {
            return CatchNotificationAsync(async () => {
                ...
                return response.Songs.First() as ITrack;
            });
        }
    ...
    public class Player
    {
        ...
        {
            var track = _trackService.GetTrackDetailAsync(id).Result;
        ...
        public void ReplacePlaylist(IEnumerable<long> trackIds, int sourceId, string sourceType, int? autoPlayTrackId = null)
        {
